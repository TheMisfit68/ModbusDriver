...
public class IOmodule{
    ...
    func readAllInputs(connection modbus:OpaquePointer){
        ...
        for analogRange in self.analogInRanges{
            ...
            modbus_read_input_registers(modbus, Int32(analogRange.lowerBound), Int32(analogRange.count), ioValues)
        ...
        for digitalRange in self.digitalInRanges{
            ...
            modbus_read_input_bits(modbus, Int32(digitalRange.lowerBound), Int32(digitalRange.count), ioValues)
    ...
    func writeAllOutputs(connection modbus:OpaquePointer){
        ...
        for analogRange in self.analogOutRanges{
            ...
            modbus_write_registers(modbus, Int32(analogRange.lowerBound), Int32(analogRange.count), ioValues)
        }
        ...
        for digitalRange in self.digitalOutRanges{
            ...
            modbus_write_bits(modbus, Int32(digitalRange.lowerBound), Int32(digitalRange.count), ioValues)
        }
